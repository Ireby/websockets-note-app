//*--------------funsiones que interactuan con la interface usuario
/*
  ...
  <div class="card card-body rounded-0 animate__animated animate__fadeInUp mb-2">
      <div class="d-flex justify-content-between">
          ...
          <div>
              ...
              <button class="btn btn-secondary update" data-id="${note._id}">update in from</button>
          </div>
      </div>
...
export const fillForm = (note) => { //llennar el formulario recibe la nota 
